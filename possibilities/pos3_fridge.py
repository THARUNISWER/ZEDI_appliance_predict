...
'''
fridge processor with variable window size
'''
...
out = model.predict([data_b[1:50] - data_c[1:50]])
...
with open("../model_data/fridge_pos3_model.json", "w") as json_file:
    json_file.write(model_json)
# serialize weights to HDF5
model.save_weights("../model_data/fridge_pos3_model.h5")
