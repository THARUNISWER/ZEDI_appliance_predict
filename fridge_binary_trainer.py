...
loaded_model_gey.load_weights("model_data/geyser_binary_model.h5")
...
x = Dropout(0.2)(x)
x = LSTM(units=128)(x)
output = Dense(units=100, activation='linear')(x)
...
with open("model_data/fridge_binary_model.json", "w") as json_file:
    json_file.write(model_json)
# serialize weights to HDF5
model.save_weights("model_data/fridge_binary_model.h5")
